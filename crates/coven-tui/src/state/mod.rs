...
impl PersistedMessage {
    ...
    /// Convert from coven_client::Message
    pub fn from_client_message(msg: &coven_client::Message) -> Self {
        Self {
    ...
    /// Convert to coven_client::Message
    pub fn to_client_message(&self) -> coven_client::Message {
        coven_client::Message {
            id: format!(
                "{}-{}",
...
impl AppState {
    ...
    pub fn get_messages(&self, agent_id: &str) -> Vec<coven_client::Message> {
