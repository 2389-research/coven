// ABOUTME: Bridges coven-client callbacks to AppEvent.
...
use coven_client::{ConnectionStatus, StateCallback, StreamCallback, StreamEvent};
...
impl ClientBridge {
    ...
    /// Convert the bridge into callback trait objects for coven-client.
