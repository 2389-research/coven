        ...
        self.conn
            .initialize(
                acp::InitializeRequest::new(acp::ProtocolVersion::V1)
                    ...
                    .client_info(
                        acp::Implementation::new("coven-swarm-acp", env!("CARGO_PKG_VERSION"))
                            .title("coven-swarm ACP Backend"),
                    ),
            )
            .await
...
/// ACP backend implementation that implements coven-core's Backend trait.
///
