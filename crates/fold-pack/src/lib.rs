// ABOUTME: Rust SDK for building tool packs that connect to fold-gateway.
// ABOUTME: Provides ManifestBuilder, ToolHandler trait, and PackClient for pack development.

//! # fold-pack
//!
//! A Rust SDK for building tool packs that provide tools to fold agents.
//!
//! Tool packs connect to fold-gateway and register a set of tools that agents
...
//!
//! ```ignore
//! use fold_pack::{ManifestBuilder, PackClient, PackConfig, ToolHandler, ToolError};
...
pub use fold_proto::{ExecuteToolRequest, ExecuteToolResponse, PackManifest, ToolDefinition};
