...
impl From<GitInfo> for fold_proto::GitInfo {
...
impl From<AgentMetadata> for fold_proto::AgentMetadata {
    fn from(meta: AgentMetadata) -> Self {
        fold_proto::AgentMetadata {
...
mod tests {
    ...
    fn test_metadata_to_proto_includes_backend() {
        ...
        let proto_meta: fold_proto::AgentMetadata = metadata.into();
