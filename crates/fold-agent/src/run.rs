// ABOUTME: Public entry points for running fold-agent from external crates.
// ABOUTME: Exposes run_agent and run_wizard for use by fold-cli.
...
///
/// This is the main entry point for running a fold agent. It handles:
