// ABOUTME: TUI runner for fold-agent - visual display of agent activity
            ...
            Some(Ok(msg)) => match msg.payload {
                Some(server_message::Payload::Welcome(welcome)) => {
                    ...
                    tx.send(UiEvent::Block(
                        BlockKind::System,
                        format!(
                            "To bind a channel: Slack: /fold bind {} | Matrix: !fold bind {}",
                    ...
                    Err(e) => {
                        ...
                        let error_response = AgentMessage {
                            payload: Some(agent_message::Payload::Response(MessageResponse {
                                ...
                                event: Some(fold_proto::message_response::Event::Error(
                                    e.to_string(),
                                )),
                            })),
                        };
