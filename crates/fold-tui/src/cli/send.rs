...
use fold_client::{FoldClient, StreamCallback, StreamEvent};
...
fn find_agent(agents: &[fold_client::Agent], query: &str) -> Option<fold_client::Agent> {
...
fn build_agent_hint(agents: &[fold_client::Agent]) -> String {
    if agents.is_empty() {
